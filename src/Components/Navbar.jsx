...
export default function Navbar() {
  ...
  return (
    <>
      <Box bg={useColorModeValue('#ffffff', '#ffffff')}   px={0} boxShadow='lg' pos="sticky" top={"0px"} zIndex="10000" h = {{sm: '3.5em', md: '3.8em',lg: '4.6em',xl: '4.7em','2xl': '5em',}} w={"100%"}  >
        <Flex  h = {{sm: '3.5em', md: '3.8em',lg: '4.6em',xl: '4.7em','2xl': '5em',}} w={"100%"} alignItems={'center'} justifyContent={'space-between'}  >
          <IconButton
            size={'md'}
          ...
          <HStack spacing={8} alignItems={'center'} w={"53%"}  >
            <Box   >  <Image onClick={()=> navigate("/")} h={10} src='https://assets.milaap.org/assets/milaap-logo-tiny-4d3dbc4e55c2aaec351f0f376329c624236c4d6266b910f472684e70603f600d.png' alt='Dan Abramov' /></Box>
            <HStack
          ...
          <Switch height={25} width={75} handleDiameter={31} boxShadow="1px 2px 2px grey" onChange={()=> setcheck(!checke)}  checked={checke} onColor={"#9c3353"} offColor={"#9c3353"} checkedIcon={<div style={textSwitch}>INR</div>} uncheckedIcon={<div style={textSwitch}>USD</div>} />
          </Box>
          ...
          <Flex alignItems={'center'}  w={{sm: '10em', md: '15em',lg: '25em',xl: '32em','2xl': '34em',}} justifyContent="space-around">
          <Button
  ...
  color={"white"}
  variant="solid"
  _hover={{shadow: "rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;"}}
  _focus={{color:"white",background:"#9c3353"}}
  
  padding={{sm: '1.3em', md: '1.2em',lg: '1em',xl: '1em','2xl': '1em',}}
...
<path d="M22.5759 20.4688C21.4107 20.4688 20.8884 21.125 19 21.125C17.0714 21.125 16.5491 20.4688 15.3839 20.4688C12.4107 20.4688 10 22.9707 10 26.0059V27.0312C10 28.1387 10.8438 29 11.9286 29H26.0714C27.1161 29 28 28.1387 28 27.0312V26.0059C28 22.9707 25.5491 20.4688 22.5759 20.4688ZM26.0714 27.0312H11.9286V26.0059C11.9286 24.0371 13.4554 22.4375 15.3839 22.4375C15.9866 22.4375 16.9107 23.0938 19 23.0938C21.0491 23.0938 21.9732 22.4375 22.5759 22.4375C24.5045 22.4375 26.0714 24.0371 26.0714 26.0059V27.0312ZM19 19.8125C22.1741 19.8125 24.7857 17.1875 24.7857 13.9062C24.7857 10.666 22.1741 8 19 8C15.7857 8 13.2143 10.666 13.2143 13.9062C13.2143 17.1875 15.7857 19.8125 19 19.8125ZM19 9.96875C21.0893 9.96875 22.8571 11.7734 22.8571 13.9062C22.8571 16.0801 21.0893 17.8438 19 17.8438C16.8705 17.8438 15.1429 16.0801 15.1429 13.9062C15.1429 11.7734 16.8705 9.96875 19 9.96875Z" fill="#9C3352"></path>
              ...
              <MenuList display={"flex"} >
                <MenuItem w={"50%"} onClick={()=> navigate("/login")} >Login</MenuItem>
                <MenuDivider />
                <MenuItem w={"50%"} onClick={()=> navigate("/register")}  >Register</MenuItem>
